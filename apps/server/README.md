...
| PLATFORM_CODE_SERVER_BIN | code-server | 可执行文件。Windows 上若 PATH 里是残缺的 npm 包，会自动改用 WSL `~/.local/code-server`。也可写成 `wsl:/home/你/.local/code-server/bin/code-server` |
